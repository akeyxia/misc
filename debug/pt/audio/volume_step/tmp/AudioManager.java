...
public class AudioManager {
    ...
    /** The audio stream for AUX */
    public static final int STREAM_AUX = AudioSystem.STREAM_AUX;
    /** The audio stream for NAV */
    public static final int STREAM_NAV = AudioSystem.STREAM_NAV;
    /** The audio stream for NAV_NOVICE */
    public static final int STREAM_NAV_NOVICE = AudioSystem.STREAM_NAV_NOVICE;
    /** The audio stream for RECORD */
    public static final int STREAM_RECORD = AudioSystem.STREAM_RECORD;
    /** The audio stream for IVOKA */
    public static final int STREAM_IVOKA = AudioSystem.STREAM_IVOKA;
    /** The audio stream for WALKIETALKIE */
    public static final int STREAM_WALKIETALKIE = AudioSystem.STREAM_WALKIETALKIE;
    /** The audio stream for BLUETOOTH_MUSIC */
    public static final int STREAM_BLUETOOTH_MUSIC = AudioSystem.STREAM_BLUETOOTH_MUSIC;
    /** @hide The audio stream for AM */
    public static final int STREAM_AM = AudioSystem.STREAM_AM;
    ...
    public static final int[] DEFAULT_STREAM_VOLUME = new int[] {
        ...
        12,  // STREAM_AUX
        14,  // STREAM_NAV
        14,  // STREAM_NAV_NOVICE
        12,  // STREAM_RECORD
        12,  // STREAM_IVOKA
        12,  // STREAM_WALKIETALKIE
        12,  // STREAM_BLUETOOTH_MUSIC
        12,  // STREAM_AM
    };
    ...
    /**
     * Get mute state of an audio stream.
     *
     * @param streamType The stream to get state of muted/unmuted.
     * @return Mute state of the stream
     */
    ...
    */
    ...
    /**
     * Fmam audio mode. A Fm/Am is established.
     */
    public static final int MODE_FMAM               = AudioSystem.MODE_FMAM;
    /**
     * DVD audio mode. A DVD is established.
     */
    public static final int MODE_DVD                = AudioSystem.MODE_DVD;
    /**
     * In call audio mode. A Record is established.
     */
    public static final int MODE_RECORD             = AudioSystem.MODE_RECORD;
