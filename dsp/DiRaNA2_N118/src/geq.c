...
static void DB2Val_5BandGeq(int band, float fc, int gain, float Q)
{
	...
	if (band <= 3)
		printf("0x%03x, 0x%03x, 0x%03x, 0x%03x, 0x%03x, 0x%03x, 0x%03x, /* band %d %ddB */\n", b0l, b0h,
				a2l, a2h, a1l, a1h, gc, band, gain);
	else
		printf("0x%03x, 0x%03x, 0x%03x, 0x%03x, 0x000, 0x000, 0x000, /* band %d %ddB */\n", b0l, a2l,
				a1l, gc, band, gain);
}
...
int main(int argc, char *argv[])
{
	...
	printf("b0high, b0low, a1high, a1low, a2high, a2low\n");
        printf("Band %d\n", 1);
        for (i = -12; i <= 12; i++) {
